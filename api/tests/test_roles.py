...
def test_success_create_role_listing(mock_create_role_listing):
    ...
    # Act
    response = client.post("/role/role_listing", json=role_details, headers=headers)
...
def test_success_get_all_role_listings(mock_get_all_role_listings):
    ...
    response = client.get(f"/role/role_listing", headers=headers)
    print(response.json())
...
def test_success_get_role_listings(mock_get_role_listings):
    ...
    response = client.get(f"/role/role_listing?role_listing_id=0", headers=headers)
...
def test_success_get_all_role_details(mock_get_all_role_details):
    ...
    response = client.get(f"/role/role_details", headers=headers)
...
def test_success_get_role_details(mock_get_role_details):
    ...
    response = client.get(f"/role/role_details?role_id=234511581", headers=headers)
...
def test_failure_role_not_exist_get_role_details(mock_get_role_details):
    ...
    # Act
    response = client.get(f"/role/role_details?role_id=123", headers=headers)
