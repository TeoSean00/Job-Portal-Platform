...
class RoleSkills(Base):
    ...
    role_id = Column(
        Integer, ForeignKey("ROLE_DETAILS.role_id"), primary_key=True
    )
    skill_id = Column(
        Integer, ForeignKey("SKILL_DETAILS.skill_id"), primary_key=True
    )
...
class StaffReportingOfficer(Base):
    ...
    staff_id = Column(
        Integer, ForeignKey("STAFF_DETAILS.staff_id"), primary_key=True
    )
    RO_id = Column(
        Integer, ForeignKey("STAFF_DETAILS.staff_id"), nullable=False
    )
...
class StaffSkills(Base):
    ...
    ss_status = Column(
        Enum("active", "unverified", "in-progress"), nullable=False
    )
